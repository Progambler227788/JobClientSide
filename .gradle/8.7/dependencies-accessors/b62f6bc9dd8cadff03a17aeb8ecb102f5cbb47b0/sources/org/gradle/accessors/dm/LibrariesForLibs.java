...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>shimmerrecyclerview</b> with <b>com.github.sharish:ShimmerRecyclerView</b> coordinates and
     * with version reference <b>shimmerrecyclerviewVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getShimmerrecyclerview() {
        return create("shimmerrecyclerview");
    }
    ...
    public static class ShimmerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>recyclerview</b> with <b>com.github.henrytao:shimmer-recyclerview</b> coordinates and
         * with version reference <b>shimmerRecyclerview</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getRecyclerview() {
            return create("shimmer.recyclerview");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>shimmerRecyclerview</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShimmerRecyclerview() { return getVersion("shimmerRecyclerview"); }

        /**
         * Version alias <b>shimmerrecyclerviewVersion</b> with value <b>v1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShimmerrecyclerviewVersion() { return getVersion("shimmerrecyclerviewVersion"); }
